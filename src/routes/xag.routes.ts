...
router.get('/api/noflyzone/api/get_paging', AuthController.GetPaging); // deprecated
...
router.get('/api/land/v1/route/initAllRoute', MapsController.InitAllRoutes); // deprecated
...
router.post('/flightImageTask/page', MapsController.FlightImageTaskPage); // check /flightImageTask/page/union/flyMapAndImport
...
router.get('/api/land/v1/initAllLand', MapsController.InitAllLand); // deprecated
